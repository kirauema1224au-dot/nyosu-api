...
const suddenDeathCaptions = {
  ...
  agQ23NdBROY: [
    ...
    { startSec: 36, endSec: 42, text: "時間を忘れて夢中になった 赤信号は点滅してる", romaji: "Jikan o wasurete muchū ni natta akashingō wa tenmetsushiteru" },
    { startSec: 42, endSec: 49, text: "肌寒くなり始めた季節に 僕らは初めて手をつないだ", romaji: "Hadasamuku nari hajimeta kisetsu ni bokura wa hajimete te o tsunaida" },
    { startSec: 49, endSec: 54, text: "二人の物語", romaji: "Ni nin no monogatari" },
    { startSec: 54, endSec: 60, text: "ふたりでひとつの傘をさしたり ブランコに乗り星を眺めたり", romaji: "Futari de hitotsu no kasa o sashi tari buranko ni noriboshi o nagame tari" },
    { startSec: 60, endSec: 66, text: "押しボタン式の信号機を いつも君が走って押すくだり", romaji: "Oshi botanshiki no shingōki o itsumo kimi ga hashitte osu kudari" },
    { startSec: 66, endSec: 73, text: "仰向けになってみた湖 宙に浮いてるみたいってさ", romaji: "Aomuke ni nattemita mizuumi chū ni uiteru mitai tte sa" },
    { startSec: 73, endSec: 79, text: "はしゃいでる君とその横でさ もっとはしゃぐ僕なら", romaji: "Hashaideru kimi to sono yoko de sa motto hashagu boku nara" },
    { startSec: 79, endSec: 85, text: "本当に飛べるような気がしていた", romaji: "Hontōni toberu yōna ki ga shiteita" },
    { startSec: 85, endSec: 93, text: "ふわふわと夢心地 君の隣", romaji: "Fuwafuwa to yumegokochi kimi no tonari" },
    { startSec: 93, endSec: 107, text: "君の見る景色を全部 僕のものにしてみたかったんだ", romaji: "Kimi no miru keshiki o zenbu boku no mono ni shitemitakatta n da" },
    { startSec: 107, endSec: 128, text: "君を忘れられんなあ", romaji: "Kimi o wasureraren nā" },
    { startSec: 128, endSec: 135, text: "当たり前に通ってたあの道 信号機は無くなるみたいです", romaji: "Atarimae ni kayotteta ano michi shingōki wa nakunaru mitai desu" },
    { startSec: 135, endSec: 141, text: "思い出して切なくなる気持ちも いつかは無くなるみたいです", romaji: "Omoidasite setsunaku naru kimochi mo itsuka wa nakunaru mitai desu" },
    { startSec: 141, endSec: 147, text: "そういえば寒い雪降る日の 田和山の無人公園でさ", romaji: "So ieba samui yuki furu hi no Tawasan no mujin kōen de sa" },
    { startSec: 147, endSec: 156, text: "震える体 暗い中 いつものように笑い合う 街灯の下で", romaji: "Furueru karada kurai naka itsumo no yōni warai au gaitō no shita de" },
    { startSec: 156, endSec: 170, text: "僕の目に映り込んだ君が いつもよりちょっと寂しそうな気がした", romaji: "Boku no me ni utsurikonda kimi ga itsumo yori chotto sabishisō na ki ga shita" },
    { startSec: 170, endSec: 183, text: "今になってさ 思い出してさ 後悔じゃなにも解決しないさ", romaji: "imaninattesaomoidasitesakoukaizyananimokaiketusinaisa" },
    { startSec: 183, endSec: 189, text: "忘れられないのは 受け入れられないのは", romaji: "Wasurerarenai no wa ukeirerarenai no wa" },
    { startSec: 189, endSec: 199, text: "君を思い出にできるほど僕は 強くはないから", romaji: "Kimi o omoide ni dekiru hodo boku wa tsuyoku wa nai kara" },
    { startSec: 199, endSec: 217, text: "僕の見た景色を全部 君にも見せてやりたかったんだ あったかいココアを一口", romaji: "Boku no mita keshiki o zenbu kimi ni mo miseteyaritakatta n da attakai kokoa o ichi kuchi" },
    { startSec: 217, endSec: 230, text: "いつかまた逢う日までと 笑う顔に嘘は見当たらない", romaji: "itsuka mata mōu hi made to warai au koto ni kusō wa miranakaranai" },
    { startSec: 230, endSec: 241, text: "じゃあね じゃあね またどっか遠くで", romaji: "yāne yāne mata dōka yaku de" },
