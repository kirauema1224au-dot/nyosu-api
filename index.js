...
const suddenDeathCaptions = {
  ...
  "U8pJgoOhiDs": [
    ...
    { startSec: 57, endSec: 63, text: "さよなら 最後まで愛していたんだ 嘘じゃない", romaji: "sayonarasaigomadeaisiteitanndausozyanai" },
    { startSec: 63, endSec: 69, text: "勝手だって怒るかな 本当馬鹿だったよ ごめんな。", romaji: "kattedatteokorukanahonntobakadattayogomennna" },
    { startSec: 69, endSec: 74, text: "君の方はきっと新しい場所が出来たんだね", romaji: "kiminohouhakittoatarasiibasyogadekitanndane" },
    { startSec: 74, endSec: 91, text: "ごめんねとか要らないよ 君が言うなよ", romaji: "gemennnetokairanaiyokimigaiunayo" },
    { startSec: 91, endSec: 97, text: "髪の毛の色 変わったらしいね", romaji: "kaminokenoirokawattarasiine" },
    { startSec: 97, endSec: 103, text: "黒からゴールド 赤 黒 それから青って一体", romaji: "kurokarago-rudoakakurosorekaraaotteittai" },
    { startSec: 103, endSec: 108, text: "ふたりで居た日々も 塗り変えているんだろうか", romaji: "hutarideitahibimonurikaeteirunndarouka" },
    { startSec: 108, endSec: 115, text: "信じ難いけど僕の方は今でも会おうって言いたい", romaji: "sinnzigataikedobokunohouhaaoutteiitai" },
    { startSec: 115, endSec: 120, text: "泣いてる君が ごめん なんかじゃなくて", romaji: "naiteirukimiagagomennnannkazyanakute" },
    { startSec: 120, endSec: 126, text: "欲しかった言葉別れた今でも", romaji: "hosikattakotobawakaretaimademo" },
    { startSec: 126, endSec: 132, text: "また勝手な事言って 期待しちゃうじゃない", romaji: "matakattenakotoittekitaisityauzyanai" },
    { startSec: 132, endSec: 138, text: "いつだってそうだから 絶対以外約束しないで", romaji: "itudattesoudakarazettaiigaiyakusokusinaide" },
    { startSec: 138, endSec: 143, text: "次の子にはきっと優しくしてあげてよね", romaji: "tuginokonihakittoyasasikusiteageteyone" },
    { startSec: 143, endSec: 150, text: "約束だからね なんて 君が言うなよ", romaji: "yakusokudakaranenanntekimigaiunayo" },
    { startSec: 150, endSec: 161, text: "伝えたかった言葉など", romaji: "tutaetakattakotobanado" },
    { startSec: 161, endSec: 171, text: "ひとつも言えないまま", romaji: "hitotumoienaimama" },
    { startSec: 171, endSec: 177, text: "さよなら 君はきっと忘れて行く道で", romaji: "sayonarakimihakittowasureteikumitide" },
    { startSec: 177, endSec: 183, text: "とっくのとうに もっとマシな人 捕まえたんだ", romaji: "tokkunotounimottomasinahitotukamaetannda" },
    { startSec: 183, endSec: 188, text: "僕の方はずっと抜け殻みたいだよ", romaji: "bokunohouhazuttonukegaramitaidayo" },
    { startSec: 188, endSec: 195, text: "本当は今でも なんて 君が言うなよ", romaji: "honntohaimademonanntekimigaiunayo" },
    { startSec: 195, endSec: 289, text: "今更だって僕は言うかな", romaji: "imasaradattebokuhaiukana" }
  ]
